//
//  MyOtherTableViewController.swift
//  CustomTableView
//
//  Created by Stephanie Catalano on 7/20/16.
//  Copyright © 2016 Stephanie Catalano. All rights reserved.
//

import UIKit

class MyOtherTableViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        if let con : contacts = contact! {
            
            firstName.text = con.fN
            lastName.text = con.lN
            emailAddress.text = con.email
            phoneNumber.text = con.phNum
